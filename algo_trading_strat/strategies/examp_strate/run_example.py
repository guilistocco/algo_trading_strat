...
from signal_example import generate_signal
...
from config_example import SYMBOL, QTY

logger = setup_logger(strategy='example_strategy')
...
def main_loop():
    ...
    try:
        ...
        logger.info("\n[INFO] Execution interrupted by user. Safely shutting down...")
